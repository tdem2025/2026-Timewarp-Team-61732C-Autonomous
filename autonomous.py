...
drone.send_absolute_position(1.54, 0, 0.6, 0.5, 0, 0)
drone.set_yaw(0)
drone.send_absolute_position(1.54, 0, 0.6, 0.5, 0, 0)
...
drone.send_absolute_position(1.54, 0, 0.6, 0.5, 0, 0)
drone.send_absolute_position(3.14, 0, 0.6, 0.5, 0, 0)
drone.set_yaw(0)
drone.send_absolute_position(3.14, 0.4, 0.6, 0.5, 0, 0)
drone.set_yaw(0)
drone.send_absolute_position(4.41, 0.4, 0.6, 0.5, 0, 0)
drone.set_yaw(0)
drone.send_absolute_position(4.41, 0, 0.6, 0.5, 0, 0)
drone.set_yaw(0)
